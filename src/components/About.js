...
function About() {
  ...
  return (
    ...
    <div className=' 2xl:h-screen xl:h-[100vh] bg-cover w-[100%] bg-no-repeat p-4 pt-0 text-white h-screen sm:overflow-auto'   data-aos="fade-in" data-aos-duration="3000"  style={{backgroundImage : `url(${bg})`}} >
    <div className='absolute left-0  bg-[#1f1f1faa] w-[100%] h-[100%] '></div>
    <h1 className='w-[100%] text-center  text-6xl backdrop-blur-sm pt-2 sm:text-2xl '> ABOUT US</h1>
    <div className=' text-center '>
    {/* <img src={bg} alt="" className='p-8'/>  */}
    </div>
    <div className='w-[100%] sm:text-sm xl:text-xl 2xl:text-xl p-8 backdrop-blur-sm '>
...
portfolio, leveraging our trading expertise and strategic alliances.</p>
      ...
      <div className='p-2 border border-black shadow-2xl mt-4 rounded-lg 2xl:w-[50%] xl:w-[50%] sm:w-full'>
    ...
    <div className=' w-[95%] flex flex-shrink 2xl:flex-row xl:flex-row 2xl:flex-shrink justify-center items-center  sm:flex-col'>
      ...
      <img src="https://www.ssplindia.net/wp-content/uploads/2019/05/PS.jpg" alt="" className='object-contain xl:pl-8 xl:pr-8' />
      <h1 className='text-xl font-bold mt-4'>Mr. Pulkit Sekhsaria </h1>
      <p className='mt-6'>Promoter</p>
