    ...
    <div class="relative wrap overflow-auto ">
        ...
        <div class="mb-8 lg:flex justify-between items-center w-full right-timeline ">
            ...
            <div class="order-1 lg:w-5/12 px-6 py-4">
                ...
                <p class="text-gray-700 leading-tight text-xl"> Established as brokers for major corporations including the Mafatlals and the Vardhman Group.
...
USFDA-approved API manufacturing.</p>
        ...
        <div class="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div class="order-1 lg:w-5/12 px-6 py-4">
                ...
                <p class="text-gray-700 leading-tight text-xl">GACL is promoted as a joint venture with the Gujarat government, which later sells its stake to the promoters.GACL starts
...
at Muldwarka, Gujarat.</p>
        ...
        <div class="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div class="order-1 lg:w-5/12 px-6 py-4">
                ...
                <p class="text-gray-700 leading-tight text-xl"> GACL sets up its third port at Hazira, South Gujarat. GACL becomes the top player in Mumbais retail cement market.
...
Acquires a 51% stake in DLF Cement, becoming the #4 cement company in India.</p>
        ...
        <div class="mb-8 lg:flex justify-between flex-row-reverse items-center w-full left-timeline">
            ...
            <div class="order-1 lg:w-5/12 px-6 py-4">
                {/* <h3 class="mb-3 font-bold text-gray-800 text-xl">GACL</h3> */}
                <p class="text-gray-700 leading-tight text-xl">Acquires a 51% stake in DLF Cement, becoming the #4 cement company in India. Acquires Associated Cement Companies
(ACC) from the Tatas.Sells 67% of Ambuja Cement India (ACC + Modi Cement) to Holcim.</p>
        ...
        <div class="mb-8 lg:flex justify-between items-center w-full right-timeline">
            ...
            <div class="order-1  lg:w-5/12 px-6 py-4">
                {/* <h3 class="mb-3 font-bold text-gray-800 text-xl">Sekhsaria Chemicals Pvt. Ltd.</h3> */}
                <p class="text-gray-700 leading-tight text-xl"> GACL, with a 16.2 million ton capacity, is sold to Holcim, making it the world’s largest cement maker. Acquired by Watson
