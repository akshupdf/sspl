...
function Navbar() {
  return (
    <div className='lg:flex backdrop-blur-2xl bg w-[100%] font-serif bg-green-800 text-white'>
  <div className='lg:flex cursor-pointer  w-[50%]'>
  <img src={logo} alt="" className='w-60 h-30  right-0'/>
  </div>
   <div className='lg:flex cursor-pointer  w-[50%] justify-end m-auto '>
   <ul className='lg:flex cursor-pointer  w-[50%] right-0 text-xl'>
